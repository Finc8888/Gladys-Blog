...
date: 2025-10-05
summary: "Симметричное шифрование использует один ключ для шифрования/расшифровки (AES, ChaCha20), асимметричное - пару ключей (RSA, ECC). Симметричное - для больших данных, асимметричное - для обмена ключами и цифровых подписей"
draft: false
