...
summary: "Подробное руководство по созданию и редактированию статей в статическом генераторе сайтов Hugo. Изучите основы работы с контентом, метаданными и структурой блога."
