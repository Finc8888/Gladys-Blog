...
date: 2025-10-05
summary: "Позднее статическое связывание (static::) позволяет обращаться к методам и свойствам вызываемого класса, а не класса где они определены. Ключевое отличие от self:: в поведении при наследовании"
draft: false
